"""Online EWC n=10 multi-seed bench on chained-15.

n=10 rerun for the ArXiv-ready paper draft.

Run:
  python3 -m experiments.bench_online_ewc_chained_15_n10 \
      > outputs/bench_chained_15task_n10_ONLINE_EWC.log 2>&1
"""
...
def main() -> int:
    argv = [
        ...
        "--arms", "online_ewc",
        "--csv", "bench_chained_15task_n10_ONLINE_EWC.csv",
    ]
    print("Online EWC n=10 multi-seed (chained-15)")
