"""PackNet n=10 multi-seed bench on chained-15.

n=10 rerun for the ArXiv-ready paper draft.

Run:
  python3 -m experiments.bench_packnet_chained_15_n10 \
      > outputs/bench_chained_15task_n10_PACKNET.log 2>&1
"""
...
def main() -> int:
    argv = [
        ...
        "--csv", "bench_chained_15task_n10_PACKNET.csv",
    ]
    print("PackNet n=10 multi-seed (chained-15)")
    print()
