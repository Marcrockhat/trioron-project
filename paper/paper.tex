...
\author{Marcelinus R.\ Hatorangan%
        \thanks{Correspondence: \texttt{marcelinusrocky@aol.com}.
                ...
                Guided tour: \href{https://marcrockhat.github.io/trioron-project/}{marcrockhat.github.io/trioron-project}.}}
\date{2026-05-10}
...
storage. Forgetting is negative across all ten seeds
($-0.562 \pm 0.010$ on \arm{grown\_uncapped\_dream}): past-class
...
Manifold replay Pareto-dominates hippo $K = 10$ on this benchmark
...
\href{https://marcrockhat.github.io/trioron-project/}{marcrockhat.github.io/trioron-project}. The repository
...
deliberate --- it is the privacy contract of the substrate, an
irreversible compression that ensures L0 codes leaked from a device do
not reveal the original input beyond a 128-d projection. The natural
question is whether donors can disagree on something that does not
also throw away the privacy guarantee.
...
The privacy property is preserved: $S$ is the lossy stage and is
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \emph{$\sigma$-vs-baseline}: paired-by-seed standardized
        effect size across the random-seed cohort (10 seeds for
        headline panels; 3 seeds for the dream-archive panel),
        reported alongside absolute $\Delta$. We are explicit that
